...
class EcommerceTracker:
    ...
    def _generate_simulated_market_data(
        ...
        # 3. Upper Mid-Range Smartphones (Nothing 2a/3a, Realme P4 Lite, Realme P1/P2/12 Pro, CMF, OnePlus Nord, Realme GT, Poco F6, iQOO Neo)
        ...
        # 4. Budget & Value Smartphones (Redmi, Realme Narzo/C, Poco M, Moto G, Samsung M/A, Infinix, Tecno, Lava)
